...
environment {
	...
	CONTAINER_NAME = 'flaxtest'
	CONTAINER_REPOSITORY = 'sparklyballs/flaxtest'
	GITHUB_RELEASE_URL_SUFFIX = 'Flax-Network/flax-blockchain/releases/latest'
	GITHUB_REPOSITORY = 'sparklyballs/flaxtest'
